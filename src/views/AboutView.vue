<template>
  <v-container>
    ...
    <v-card-text>
      ...
      The player with the most discs on the board at the end of the game wins. If both players have the same number of
      discs, then the game is a draw.
    </v-card-text>
